...
export default function ProductItem({ productName , productDesc , price ,productImageURL, productOwnerName ,sizes }) {
    ...
    <>
      ...
      >
        ...
        <div className="flex bg-transparent justify-center items-center">
          {sizes.map((size) => (
            <div
              className="bg-transparent p-1 m-1 text-white "
              style={{ borderRadius: "50%", border: "1px solid white" ,fontSize:"6px"}}
            >
              {size}
            </div>
          ))}
