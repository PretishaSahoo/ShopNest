          ...
          <div className="flex items-center w-full md:w-3/5 bg-gray-900 rounded p-2 mb-4 md:mb-0" style={{ boxShadow: "0 0 20px 10px rgba(128, 128, 128, 0.1)" }}>
            ...
            >
              <path
                ...
                strokeWidth={2}
                d="M11 4a7 7 0 100 14 7 7 0 000-14zm0 14a7 7 0 01-7-7 7 7 0 017-7 7 7 0 01-7 7zm9.07-2.93a1 1 0 00-1.414 0l-2.829 2.828a1 1 0 001.414 1.414l2.828-2.828a1 1 0 000-1.414z"
              />
            </svg>
            <input
              type="text"
